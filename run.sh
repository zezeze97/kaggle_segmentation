...
config=upernet_swinv2_large_patch4_window12to24_192to384_22kto1k_OHEM_TTA
if [ $1 = "train" ]; then
    ...
    CUDA_VISIBLE_DEVICES=$GPU PORT=23472 ./tools/dist_train.sh configs/swin_v2/${config}.py 1 --work-dir cache/${config} 
elif [ $1 = "test" ]; then
