...
config=upernet_swin_v2_base_patch4_window12_384x384_160k_kaggle25d_pretrain_384x384_22K_TTA
...
if [ $1 = "train" ]; then
    ...
    CUDA_VISIBLE_DEVICES=$GPU PORT=23473 ./tools/dist_train.sh configs/swin_v2/${config}.py 1 --work-dir cache/${config} 
elif [ $1 = "test" ]; then
