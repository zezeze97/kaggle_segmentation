...
# config=upernet_noaux_convnext_large_fp16_512x512_320k_kaggle_25d_multilabel_carno_rotate_tta
config=upernet_noaux_convnext_large_fp16_512x512_640k_kaggle_25d_multilabel_carno_rotate_tta
if [ $1 = "train" ]; then
